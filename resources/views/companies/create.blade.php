    ...
    <div class="col-lg-8">
        <div class="card card-modern p-4">
            <div class="d-flex align-items-center justify-content-between mb-4 border-bottom pb-3">
                <h5 class="fw-bold mb-0"><i class="fa-solid fa-plus-circle me-2 text-primary"></i> Create Business / Company</h5>
            ...
            <form action="{{ route('companies.store') }}" method="POST">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="name" class="form-control" value="{{ old('name') }}" required placeholder="e.g. Acme Tech Solutions">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label small fw-semibold">Legal / Registered Name</label>
                        <input type="text" name="legal_name" class="form-control" value="{{ old('legal_name') }}" placeholder="e.g. Acme Tech Solutions Pvt Ltd">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label small fw-semibold">GSTIN (15 Digits)</label>
                        <input type="text" name="gstin" class="form-control" value="{{ old('gstin') }}" placeholder="e.g. 07AAAAA0000A1Z5">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label small fw-semibold">PAN Number (10 Digits)</label>
                        <input type="text" name="pan" class="form-control" value="{{ old('pan') }}" placeholder="e.g. AAAAA0000A">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label small fw-semibold">Official Email</label>
                        <input type="email" name="email" class="form-control" value="{{ old('email') }}" placeholder="accounts@acme.com">
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="state" class="form-control" value="{{ old('state', 'Delhi') }}" required>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label small fw-semibold">State Code (GST) *</label>
                        <input type="text" name="state_code" class="form-control" value="{{ old('state_code', '07') }}" required placeholder="07">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label small fw-semibold">Currency Symbol *</label>
                        <input type="text" name="currency_symbol" class="form-control" value="{{ old('currency_symbol', '₹') }}" required>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label small fw-semibold">Currency Code *</label>
                        <input type="text" name="currency_code" class="form-control" value="{{ old('currency_code', 'INR') }}" required>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label small fw-semibold">Pincode</label>
                        <input type="text" name="pincode" class="form-control" value="{{ old('pincode') }}" placeholder="110001">
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-end gap-2 mt-4 pt-3 border-top">
                    ...
                    <button type="submit" class="btn btn-primary px-4 fw-semibold">
                        <i class="fa-solid fa-check me-1"></i> Save & Open Workspace
                    </button>
                </div>
            </form>
        </div>
