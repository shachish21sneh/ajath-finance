    ...
    <div class="col-lg-8">
        <div class="card card-modern p-4">
            <div class="d-flex align-items-center justify-content-between mb-4 border-bottom pb-3">
                <h5 class="fw-bold mb-0"><i class="fa-solid fa-user-plus me-2 text-primary"></i> Register New Customer</h5>
            ...
            <form action="{{ route('customers.store') }}" method="POST">
                ...
                <div class="row g-3">
                    <div class="col-md-8">
                        ...
                        <input type="text" name="name" class="form-control" value="{{ old('name') }}" required placeholder="e.g. Apex Tech Solutions">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label small fw-semibold">Customer Code</label>
                        <input type="text" name="code" class="form-control" value="{{ old('code') }}" placeholder="e.g. CUST-009">
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="email" name="email" class="form-control" value="{{ old('email') }}" placeholder="billing@client.com">
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="opening_balance_type" class="form-select">
                            ...
                            <option value="Cr">Cr (Advance from customer)</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-end gap-2 mt-4 pt-3 border-top">
                    ...
                    <button type="submit" class="btn btn-primary px-4 fw-semibold">Save Customer</button>
                </div>
            </form>
        </div>
    </div>
